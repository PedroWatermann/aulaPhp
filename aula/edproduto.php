            ...
            <div class="card mb-4 rounded-3 shadow-sw">
                ...
                <div class="card-body">
                    ...
                    <form action="editaproduto.php?id=<?=$id?>" method="post">
                        ...
                        <input type="text" name="descricao" id="descricao" class="form-control" value="<?=$descricao?>" required><br>
                        ...
                        <input type="number" name="quantidade" id="quantidade" class="form-control" value="<?=$quantidade?>" required><br>
